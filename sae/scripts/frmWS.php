...
if ( !$captchaData['success'] || $captchaData['score'] < $scoreMinimo || $captchaData['action'] !== 'whatsapp' ) {
...
$phpmail->Subject = 'WHATSAPP COMUNIDAD - AsistEscolar';
$phpmail->IsHTML(true);

$phpmail->Body  = '<h3 style="color:#333;">AsistEscolar.com — Nueva solicitud WhatsApp</h3>';
